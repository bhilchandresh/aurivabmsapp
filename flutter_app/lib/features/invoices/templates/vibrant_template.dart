...
class VibrantTemplate extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool hasLastItem =
        itemsList.isNotEmpty &&
        params.items.isNotEmpty &&
        itemsList.last == params.items.last;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (itemsList.isNotEmpty) _buildItemsTable(itemsList),
                ...
                Wrap(
                  ...
                  children: [
                    if ((tenant['email'] ?? '').isNotEmpty)
                      _buildHeaderPill(Icons.email, tenant['email']!),
                    if ((tenant['phone'] ?? '').isNotEmpty)
                      _buildHeaderPill(Icons.phone, tenant['phone']!),
                  ],
                ),
        ...
        children: [
          ...
          Expanded(
            ...
            child: _buildInfoCard(
              title: params.documentTitle == 'QUOTATION'
                  ? 'QUOTE TO'
                  : 'BILLED TO',
            ...
            child: _buildInfoCard(
              ...
              child:
                  ...
                  ? Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        if ((params.bankDetails['accountName'] ?? '')
                            .isNotEmpty)
                          _buildPaymentRow(
                            'Name',
  ...
  Widget _buildPaymentRow(
    ...
    return Column(
      ...
      children: [
        ...
        if (!isLast) const _DashedLine(color: Colors.black12),
      ],
    );
  }
  ...
  Widget _buildTotalRow(
    ...
    return Row(
      ...
      children: [
        Text(
          label,
          style: TextStyle(fontSize: 9, color: color ?? Colors.black87),
        ),
        Text(
