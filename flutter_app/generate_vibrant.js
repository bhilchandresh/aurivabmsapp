...
fs.writeFileSync('lib/features/invoices/templates/vibrant_template.dart', generate(false));
fs.writeFileSync('lib/features/quotations/templates/vibrant_template.dart', generate(true));
